...
#
#  $ bin/test -s ulearn5.demo -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src ulearn5.demo.testing.ULEARN5_DEMO_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/ulearn5/demo/tests/robot/test_example.robot
#
